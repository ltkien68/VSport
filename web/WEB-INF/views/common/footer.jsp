...
<footer class="site-footer">
    ...
    <div class="footer-social-block">
        ...
        <div class="footer-extra-icon">
            <a href="#" class="social-item small" aria-label="App">
    ...
    <div class="footer-bottom">
        <div class="footer-bottom-left">
            <p>Copyright © 2026 VSport.com. All rights reserved. Do not duplicate or redistribute in any form.</p>
            <p>ZALO number: 0812664035</p>
            <p class="footer-name">
                CỬA HÀNG MUA SẮM THỂ THAO TRỰC TUYẾN
                <span class="brand-footer">VIET<span style="color: #D4AF37">$</span>PORT</span>
            </p>
        </div>
        ...
        <div class="footer-bottom-links">
            <div class="footer-link-column">
                <p>MUA SẮM</p>
                <a href="${pageContext.request.contextPath}/bong_da#football_jersey_section">Mua hàng</a>
