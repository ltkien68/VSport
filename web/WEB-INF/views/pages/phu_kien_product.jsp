...
<%
    ...
    List<YeuThich> dsYeuThich
            = (List<YeuThich>) request.getAttribute("dsYeuThich");
...
<html lang="vi">
    <head>
        ...
        <link rel="stylesheet"
              href="${pageContext.request.contextPath}/assets/css/pages/phu_kien_product.css">
    ...
    <body>
        ...
        <main class="club-products-page">
            ...
            <%@ include file="/WEB-INF/views/common/phu_kien_product_nav.jsp" %>
            ...
            <section class="club-products-section">
                <div class="club-container">
                    ...
                    <div class="club-products-grid">
                        ...
                        <div class="club-product-card <%= (sp.getGiaKhuyenMai() > 0)
                                ? "has-sale"
                                : ""%>">

                            <a href="${pageContext.request.contextPath}/chi-tiet-san-pham/<%= sp.getMaSanPham()%>"
                               class="club-product-image-link">

                                <div class="club-product-image-wrap">

                                    <img
                                        src="${pageContext.request.contextPath}/<%= sp.getAnhChinh()%>"
                                        alt="<%= sp.getTenSanPham()%>"
                                        class="club-product-image club-product-image-primary">

                                    <img
                                        src="${pageContext.request.contextPath}/<%= sp.getAnhChinh() != null
                                                ? sp.getAnhChinh().replace("1.avif", "2.avif")
                                                : ""%>"
                                        alt="<%= sp.getTenSanPham()%>"
                            ...
                            <div class="club-product-info">
                                ...
                                <p class="club-product-price <%= (sp.getGiaKhuyenMai() > 0)
                                        ? "is-sale"
                                        : ""%>">
                        ...
                        <div class="club-inline-banner">
                            ...
                            <img
                                src="${pageContext.request.contextPath}/assets/images/banners/accessories-banners/<%= randomBanner%>.avif"
